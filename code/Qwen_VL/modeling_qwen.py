...
class QWenLMHeadModel(QWenPreTrainedModel):
    ...
    def forward(
        ...
        images_cd: Optional[torch.FloatTensor] = None,  # 正向增强图像
        images_cd_negative: Optional[torch.FloatTensor] = None,  # 负向增强图像
        cd_beta: Optional[torch.FloatTensor] = None,
        cd_alpha: Optional[torch.FloatTensor] = None,  # 正向增强系数
        cd_gamma: Optional[torch.FloatTensor] = None,  # 负向增强系数
